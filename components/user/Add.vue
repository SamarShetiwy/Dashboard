...
div.container.mx-auto.p-4.pt-8.ml-7.shadow-xl.mt-7.bg-gray-200.rounded-xl
    form(@submit.prevent="onSubmit")
        ...
        div.mb-4
            ...
            input(id="lastName" v-model="lastName"  v-bind="lastNameProps" type="text" class=" border mt-1 block w-full p-1 rounded-full")
        ...
        div.mb-4
            ...
            input(id="phone"  v-model="phone"  v-bind="phoneProps" type="Number" class="border mt-1 block w-full p-1 rounded-full")
