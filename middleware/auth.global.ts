...
//       const { data: response, error } = await useAsyncGql('adminUserBoard', {
//         variables: { userId ,
//           role: 'USER'
//         },
//         headers: {
...
//         return navigateTo('/login');
//       }
//       const tokenGraph = response?.value.adminUserBoard?.data?.token;
//       const role = response?.value.adminUserBoard?.data?.role
//       console.log('graphToken:', tokenGraph);
